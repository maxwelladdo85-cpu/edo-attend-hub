...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EdoSUBEB Smart Attendance System" },
      { name: "description", content: "Real-time GPS attendance tracking for teachers and students across Edo State public primary schools." },
      { name: "author", content: "EdoSUBEB" },
      { name: "theme-color", content: "#0B6B3A" },
      { property: "og:title", content: "EdoSUBEB Smart Attendance System" },
      ...
      { name: "twitter:title", content: "EdoSUBEB Smart Attendance System" },
